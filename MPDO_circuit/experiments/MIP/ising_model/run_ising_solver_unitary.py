...
def read_ising_instance(prefix, num_channels, instance):
    """
    ...
    """
    filename = f'experiments/ising_solver/ising_instances/{prefix}_{num_channels}.{instance}'
    ...
    solutions_file = f'experiments/ising_solver/ising_instances/{prefix}_{num_channels}Solutions'
    with open(solutions_file, "r") as f:
        lines = f.readlines()

    MC_val = float(lines[0].split()[instance])

    return n_spins, num_edge, J, MC_val
...
if __name__ == "__main__":
    ...
    device = "cpu"
    num_channels = 60 # number of channels
    ...
    options_ADAM = { # solver options
        'lr': 5e-3, 'lr_min': None, 'max_epochs': 2000, 
        }
    verbose = True
    ...
    # load ising instance
    num_channels, num_edge, J_mat, MC_val = read_ising_instance(prefix, num_channels, instance)
